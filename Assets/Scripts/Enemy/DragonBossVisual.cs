...
public class DragonBossVisual : MonoBehaviour
{
    ...
    public void BuildVisual()
    {
        ...
        Color bodyColor = new Color(0.42f, 0.08f, 0.18f);
        Color wingColor = new Color(0.18f, 0.04f, 0.08f);
        Color hornColor = new Color(0.28f, 0.12f, 0.32f);
        Color eyeColor = new Color(1f, 0.82f, 0.15f);

        CreatePart(visualRoot, "Body", PrimitiveType.Capsule, new Vector3(0f, 1.2f, 0f), new Vector3(2.4f, 1.6f, 2.2f), bodyColor, 0.42f, false);
        CreatePart(visualRoot, "Neck", PrimitiveType.Capsule, new Vector3(0f, 2.1f, 0.55f), new Vector3(0.9f, 0.55f, 0.9f), bodyColor, 0.4f, false);
        CreatePart(visualRoot, "Head", PrimitiveType.Sphere, new Vector3(0f, 2.55f, 1.15f), new Vector3(1.35f, 1.15f, 1.35f), bodyColor, 0.45f, false);
        ...
        CreatePart(visualRoot, "Horn_L", PrimitiveType.Cylinder, new Vector3(-0.35f, 3.05f, 1.35f), new Vector3(0.18f, 0.35f, 0.18f), hornColor, 0.55f, true);
        CreatePart(visualRoot, "Horn_R", PrimitiveType.Cylinder, new Vector3(0.35f, 3.05f, 1.35f), new Vector3(0.18f, 0.35f, 0.18f), hornColor, 0.55f, true);
        CreatePart(visualRoot, "Eye_L", PrimitiveType.Sphere, new Vector3(-0.28f, 2.75f, 1.72f), new Vector3(0.18f, 0.18f, 0.18f), eyeColor, 0.2f, true, 0.65f);
        CreatePart(visualRoot, "Eye_R", PrimitiveType.Sphere, new Vector3(0.28f, 2.75f, 1.72f), new Vector3(0.18f, 0.18f, 0.18f), eyeColor, 0.2f, true, 0.65f);
